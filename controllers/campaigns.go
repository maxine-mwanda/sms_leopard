...
func (h *Handler) SendCampaign(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.Svc.EnqueueCampaign(req.CampaignID); err != nil {
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
	if err := h.Pub.PublishSend(req.CampaignID); err != nil {
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
...
// campaign details
func (h *Handler) GetCampaignDetails(w http.ResponseWriter, r *http.Request) {
	...
	c, _, err := h.Svc.GetCampaignDetails(id)
	if err != nil {
